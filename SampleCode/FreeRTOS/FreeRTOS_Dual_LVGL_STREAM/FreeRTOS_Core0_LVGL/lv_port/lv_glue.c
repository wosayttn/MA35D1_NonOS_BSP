...
//#define CONFIG_USE_HDMI    1
#define CONFIG_USE_EDP     1
...
#else
S_CALIBRATION_MATRIX g_sCalMat = { 0, 0, 0, 0, 0, 65536 };
#endif
...
#elif defined(__1920x1080__)

#if defined(CONFIG_USE_HDMI)
//HDMI
/* LCD attributes */
...
#if defined(CONFIG_USE_HDMI)
static void LT8618_HDMI_Init(void)
{
    // driver strength
    PG->DSH = 0x333;
    PK->DSL = 0x30000;
...
#elif defined(CONFIG_USE_EDP)
static void LT8718_EDP_Init(void)
{
